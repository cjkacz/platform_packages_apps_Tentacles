...
public class ThemerSettings extends SettingsPreferenceFragment {

    private static final String TAG = "ThemerSettings";
    ...
    private String[] getTitles() {
        ...
        titleString = new String[]{
                    getString(R.string.themer_settings_title)};
        return titleString;
    }
}
